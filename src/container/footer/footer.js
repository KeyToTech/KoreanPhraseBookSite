...
const FACEBOOK_URL =
  "https://www.facebook.com/%D0%9A%D0%BE%D1%80%D0%B5%D0%B9%D1%81%D1%8C%D0%BA%D0%B8%D0%B9-%D1%80%D0%BE%D0%B7%D0%BC%D0%BE%D0%B2%D0%BD%D0%B8%D0%BA-334992067059489/?modal=admin_todo_tour";
  ...
  return (
    <div className="wrap-follow">
      ...
      <div className="follow-items">
        {followButton(<i class="fab fa-facebook-f" />, FACEBOOK_URL)}
        {followButton(<i class="fab fa-twitter" />, TWITTER_URL)}
        {followButton(<i class="fab fa-instagram" />, INSTAGRAM_URL)}
      </div>
      ...
      <div className="wrap-block">
        <div className="container-footer">
          <div className="wrap-info">
            ...
            <Link to="/privacy-policy" className="t-privacy">
              Privacy policy
            </Link>
          </div>
        </div>
        ...
        <div className="container-footer">
          <div className="wrap-contact">
            ...
            <div className="wrap-items-address">
              <p className="item">
                <strong>{props.language.titleAddress}</strong>
              </p>
        ...
        <div className="container-footer">{itemLink(props.language)}</div>
      </div>
    </div>
  </div>
);
