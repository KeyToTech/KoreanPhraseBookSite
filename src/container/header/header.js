...
import koreanImg from "../../assets/image/image_header.png";
import logo from "../../assets/logo.png";
import logoMb from "../../assets/logo.png";
import googlePlayBottom from "../../assets/android-button.png";
import iosStoreBottom from "../../assets/app-store.png";
...
function setMenu(items, href) {
  return items.map((item, index) => (
    <li className="item">
      <a href={href[index]} class={index == 0 ? "active" : ""}>
        {item}
      </a>
    </li>
  ));
...
function menu(items) {
  return (
    <div className="menu">
      <ul className="menu-items">{setMenu(items, href)}</ul>
    </div>
  );
}
  ...
  return (
    <div className="button-wrap">
      <div className="button-android">
        <a
          target="_blank"
          href="https://play.google.com/store/apps/details?id=com.keytotech.koreanphrasebook"
        >
          <img
            className="android-img"
            alt="android_img"
            src={googlePlayBottom}
          />
        </a>
      </div>
      <div className="button-ios">
        <a
          href="https://itunes.apple.com/us/app/%D0%BA%D0%BE%D1%80%D0%B5%D0%B9%D1%81%D1%8C%D0%BA%D0%B8%D0%B9-%D1%80%D0%BE%D0%B7%D0%BC%D0%BE%D0%B2%D0%BD%D0%B8%D0%BA/id1456473272"
          target="_blank"
        >
    ...
    <div className="container-btn-translation">
      <div className="wrap-btn">
        <button
          id="ukr"
          value="ukr"
          onClick={props.changeLanguageSiteUkr}
          className="btn-tr"
        >
          UKR
        </button>
        <button
          id="kor"
          value="kor"
          onClick={props.changeLanguageSiteKor}
          className="btn-tr"
        >
          KOR
        </button>
